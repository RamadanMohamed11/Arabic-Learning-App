...
class Level3SelfReading1View extends StatefulWidget {
  ...
  @override
  State<Level3SelfReading1View> createState() => _Level3SelfReading1ViewState();
}
...
ومع الاستمرار، أصبح قادرًا على قراءة التعليمات بنفسه، وشعر بثقة كبيرة في نفسه.''';
  ...
  final List<Map<String, dynamic>> questions = [
    {
      'question': '1) السبب الرئيسي لمشكلة أحمد هو:',
      'options': ['أ) صعوبة العمل', 'ب) عدم الاهتمام بالتعلم', 'ج) قلة الوقت'],
      'correctIndex': 1,
    },
    {
      'question': '2) متى شعر أحمد بوجود مشكلة؟',
      'options': ['أ) في المنزل', 'ب) في العمل', 'ج) في الشارع'],
      'correctIndex': 1,
    },
    {
      'question': '3) قرار أحمد في القصة يدل على أنه:',
      'options': ['أ) يعتمد على الآخرين', 'ب) يستطيع تطوير نفسه', 'ج) لا يحب التغيير'],
      'correctIndex': 1,
    },
    {
      'question': '4) نتيجة التزام أحمد بالتعلم كانت:',
      'options': ['أ) زيادة المشكلات', 'ب) عدم حدوث تغيير', 'ج) تحسن ثقته بنفسه'],
      'correctIndex': 2,
    },
  ];
