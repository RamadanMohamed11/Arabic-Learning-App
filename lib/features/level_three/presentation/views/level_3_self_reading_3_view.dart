...
class _Level3SelfReading3ViewState extends State<Level3SelfReading3View> {
  ...
  final String title = 'سر النظافة';
  final String storyText = '''لاحظ سكان الشارع أن بيت جارهم دائماً نظيف ومنظم جداً. كان الجار يخرج كل صباح ومعه كيس صغير يضعه في السلة. اكتشفوا أنه يجمع أي ورقة يراها في طريقه قبل أن يدخل بيته. سألوه عن السبب فقال إن نظافة الشارع تبدأ من أمام بابي. منذ ذلك اليوم قرر الجميع تقليده وأصبح الشارع أجمل مكان في المنطقة.''';

  final List<Map<String, dynamic>> questions = [
    {
      'question': '1. ماذا لاحظ الجيران على بيت جارهم؟',
      'options': ['(أ) أنه بيت قديم جداً.', '(ب) أنه دائماً نظيف ومنظم.', '(ج) أن لونه غريب.'],
      'correctIndex': 1,
    },
    {
      'question': '2. ماذا كان يفعل الجار كل صباح؟',
      'options': ['(أ) يشتري طعاماً كثيراً.', '(ب) يجمع الأوراق من الطريق ويضعها في السلة.', '(ج) يتحدث مع الناس بصوت عالٍ.'],
      'correctIndex': 1,
    },
    {
      'question': '3. ما هي الحكمة التي قالها الجار؟',
      'options': ['(أ) نظافة الشارع تبدأ من أمام بابي.', '(ب) يجب أن نغلق الأبواب دائماً.', '(ج) السكن في هذا الشارع متعب.'],
      'correctIndex': 0,
    },
    {
      'question': '4. ماذا قرر الجيران في نهاية القصة؟',
      'options': ['(أ) الرحيل من الشارع.', '(ب) تقليد الجار والحفاظ على نظافة المكان.', '(ج) عدم التحدث مع الجار مرة أخرى.'],
      'correctIndex': 1,
    },
  ];
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: Container(
                        color: Colors.white,
                        child: Image.asset(
                          'assets/images/Arabic/Level3/Activity2/3.jpeg',
