...
class _Level3SelfReading3ViewState extends State<Level3SelfReading3View> {
  ...
  final String storyText = '''لاحظ سكان الشارع أن بيت جارهم دائماً نظيف ومنظم جداً.
كان الجار يخرج كل صباح ومعه كيس صغير يضعه في السلة.
اكتشفوا أنه يجمع أي ورقة يراها في طريقه قبل أن يدخل بيته.
سألوه عن السبب فقال إن نظافة الشارع تبدأ من أمام بابي.
منذ ذلك اليوم قرر الجميع تقليده وأصبح الشارع أجمل مكان في المنطقة.''';
