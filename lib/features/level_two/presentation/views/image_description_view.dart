...
class _ImageDescriptionViewState extends State<ImageDescriptionView> {
  ...
  void _next() {
    if (_current < imageDescriptionItems.length - 1) {
      setState(() => _current++);
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    final item = imageDescriptionItems[_current];
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          'الصورة ${_current + 1} من ${imageDescriptionItems.length}',
  ...
  Widget _buildResults() {
    final total = imageDescriptionItems.length;
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                Text(
                  isPassed
                      ? 'أحسنت! كتبت أوصافًا جيدة للصور.'
                      : 'حاول إدراج كلمات مفتاحية أكثر في وصفك.',
