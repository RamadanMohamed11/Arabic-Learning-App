...
class MathLevel1MatchImagesPart2View extends StatefulWidget {
  const MathLevel1MatchImagesPart2View({super.key});

  @override
  State<MathLevel1MatchImagesPart2View> createState() => _MathLevel1MatchImagesPart2ViewState();
}

class _MathLevel1MatchImagesPart2ViewState extends State<MathLevel1MatchImagesPart2View> {
  final List<int> _numbers = [6, 7, 8, 9, 10];
  ...
  final Map<int, String> _imagePaths = {
    6: 'assets/images/6to10 activity/6.jpeg',
    7: 'assets/images/6to10 activity/7.jpeg',
    8: 'assets/images/6to10 activity/8.jpeg',
    9: 'assets/images/6to10 activity/9.jpeg',
    10: 'assets/images/6to10 activity/10.jpeg',
  };
