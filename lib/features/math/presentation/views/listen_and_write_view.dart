...
class ListenAndWriteView extends StatefulWidget {
  const ListenAndWriteView({super.key});

  @override
  State<ListenAndWriteView> createState() => _ListenAndWriteViewState();
}

class _ListenAndWriteViewState extends State<ListenAndWriteView>
  ...
  final List<_ListenWriteRound> _rounds = [
    _ListenWriteRound(
      number: 4,
      arabicLabel: 4.toArabicDigits(),
      arabicName: 'أربعة',
    ),
    _ListenWriteRound(
      number: 5,
      arabicLabel: 5.toArabicDigits(),
      arabicName: 'خمسة',
    ),
    _ListenWriteRound(
      number: 3,
      arabicLabel: 3.toArabicDigits(),
      arabicName: 'ثلاثة',
    ),
    _ListenWriteRound(
      number: 1,
      arabicLabel: 1.toArabicDigits(),
      arabicName: 'واحد',
    ),
    _ListenWriteRound(
      number: 10,
  ...
  // --- Tracing logic (same as SvgNumberTracingView) ---
  ...
  Future<void> _onRoundCompleted() async {
    ...
    if (_currentRound < _rounds.length - 1) {
      ...
      await AppTtsService.instance.speak(
        'ممتاز! لقد أكملت نشاط اسمع واكتب بنجاح!',
      );
    }
  }
